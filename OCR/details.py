...
class Aadhaar_Details(BaseModel):
    ...
    '''
    # We keep Aadhaar Number and Name as required, as a card without these is likely invalid anyway.
    ...
    # All other fields are now Optional to prevent Validation Errors on blurry images
    father_husband_name: Optional[Annotated[str, Field(None, description="father's or husband's name if visible")]] = None
    date_of_birth: Optional[Annotated[str, Field(None, description="date of birth in DD/MM/YYYY format")]] = None
    gender: Optional[Annotated[str, Field(None, description="One of : Male, Female, Transgender")]] = None
    address: Optional[Annotated[str, Field(None, description="complete address including house number, street, area, city, state")]] = None
    pincode: Optional[Annotated[str, Field(None, description="pincode")]] = None
    issue_date: Optional[Annotated[str, Field(None, description="issue date if visible")]] = None
